...
On your first run, after you have done `sc up`

<tt>sc exec -s solr bin/solr create -c development -d /opt/config</tt>

<tt>sc be rake db:schema:load db:migrate db:seed</tt>
