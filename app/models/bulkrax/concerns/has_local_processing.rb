module Bulkrax::Concerns::HasLocalProcessing
  ...
  def add_local
    ...
    if parsed_metadata['contributing_institution'].blank? ||
       !parsed_metadata['contributing_institution'].detect { |i| i.present? }
      parsed_metadata['contributing_institution'] = [contributing_institution].compact
    end
  end
