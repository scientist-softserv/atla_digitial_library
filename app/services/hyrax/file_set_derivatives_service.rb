# Hyrax 2.9.6 OVERRIDE (@sara-geezy) - dynamic width and height for videos
module Hyrax
  ...
  class FileSetDerivativesService
    ...
    private
      ...
      def create_video_derivatives(filename)
        # Do not resize image, use original file size.  This fixes aspect ratio problem. (@sara-geezy)
        size = "#{file_set.width.first}x#{file_set.height.first}"
      ...
      def create_image_derivatives(filename)
        # We're asking for layer 0, becauase otherwise pyramidal tiffs
        # flatten all the layers together into the thumbnail
