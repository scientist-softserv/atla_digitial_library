...
module Hyrax
  ...
  class BasicMetadataIndexer < ActiveFedora::RDF::IndexingService
    ...
    self.stored_and_facetable_fields = %i[resource_type creator contributor keyword publisher subject language based_near contributing_institution date place extent format_original time_period format_digital types]
